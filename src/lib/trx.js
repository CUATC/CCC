...
export default class Trx {
    ...
    getUnconfirmedBalance(address = this.tronWeb.defaultAddress.hex, callback = false) {
        ...
        this.getUnconfirmedAccount(address).then(({
            balance = 0
        }) => {
            callback(null, balance);
        }).catch(err => callback(err));
    ...
    listProposals(callback = false) {
        ...
        this.tronWeb.fullNode.request('wallet/listproposals', {}, 'post').then(({
            proposals = []
        }) => {
    ...
    getChainParameters(callback = false) {
        ...
        this.tronWeb.fullNode.request('wallet/getchainparameters', {}, 'post').then(({
            chainParameter = []
        }) => {
    ...
    listExchanges(callback = false) {
        ...
        this.tronWeb.fullNode.request('wallet/listexchanges', {}, 'post').then(({
            exchanges = []
        }) => {
